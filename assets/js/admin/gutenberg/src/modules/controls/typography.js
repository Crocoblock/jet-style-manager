...
class Typography extends BaseControl {
	...
	setDefaultArgs() {
		this.args = {
			...
			s_units: [
				{ value: 'px', label: 'PX', intervals: { step: 1, min: 1, max:200, initialPosition: 14 } },
				{ value: 'em', label: 'EM', intervals: { step: 0.1, min: 0.1, max:10, initialPosition: 1 } },
				{ value: 'rem', label: 'REM', intervals: { step: 0.1,min: 0.1, max:10, initialPosition: 1 } },
				{ value: 'vw', label: 'VW', intervals: { step: 0.1, min: 0.1, max:10, initialPosition: 1 } },
			],
			lh_units: [
				{ value: '', label: 'None', intervals: { step: 0.1, min: 0.1, max:10, initialPosition: 1 } },
				{ value: 'px', label: 'PX', intervals: { step: 1, min: 1, max:200, initialPosition: 14 } },
				{ value: 'em', label: 'EM', intervals: { step: 0.1, min: 0.1, max:10, initialPosition: 1 } },
			],
			ls_units: [],
